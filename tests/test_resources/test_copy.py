"""
Тесты для эндпоинта копирования ресурса (POST /v1/disk/resources/copy).
Проверяет синхронное и асинхронное копирование файлов и папок,
работу с параметром overwrite и обработку ошибок.
"""
