"""
Тесты для эндпоинта очистки корзины (DELETE /v1/disk/trash/resources).
Проверяет полную очистку корзины, удаление конкретных ресурсов,
работу с параметрами и обработку ошибок.
"""
