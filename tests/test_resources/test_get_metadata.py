"""
Тесты для эндпоинта получения метаинформации о ресурсе (GET /v1/disk/resources).
Проверяет получение данных о файлах и папках, работу с параметрами пагинации,
полей, превью, а также обработку ошибок запроса.
"""
